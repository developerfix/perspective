          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                txt(txt: 'Profile', fontSize: 18, fontColor: Colors.white),
                Container(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Column(
                  children: [
                    txt(txt: '993K', fontSize: 18, fontWeight: FontWeight.bold),
                ...
                Column(
                  children: [
                    txt(txt: '112', fontSize: 18, fontWeight: FontWeight.bold),
            ...
            Container(
              ...
              child: Center(
                child:
                    txt(txt: 'Follow', fontSize: 13, fontColor: Colors.white),
              ),
            )
          ],
        ),
